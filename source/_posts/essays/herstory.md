...
不，不是。要打倒的不是处于权力上位的男性，正如要打倒的不是当权者，而是父权制和资本主义制度。重要的不是在权力体系里获得权力，而是破坏掉这个权力体系。不平等并不是一个简单的变量，男性和女性在权力体系下都是被压迫者，在不同的向度上。男性和女性并不是对立的位置，事实上为了推翻不平等，必然要通过合作方式；解放女性的同时必然也要解放男性，即解放全人类。  
所以，**不要玩他们的游戏，去创造新的游戏。**
